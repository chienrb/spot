...
def t2_to_t3(theta2, l2):
    # t =    [ cos(theta2)     -sin(theta2)    0        l2*cos(theta2);
...
def t3_to_t4(theta3, l3):
    # t =    [ cos(theta3)     -sin(theta3)    0        l3*cos(theta3);
...
def t0_to_t4(theta1, theta2, theta3, l1, l2, l3):
    ...
    # return t0_to_t1(theta1,l1) @ t1_to_t2() @ t2_to_t3(theta2,l2) @ t3_to_t4(theta3,l3)
    return np.matmul(np.matmul(np.matmul(t0_to_t1(theta1,l1), t1_to_t2()), t2_to_t3(theta2,l2)), t3_to_t4(theta3,l3))
